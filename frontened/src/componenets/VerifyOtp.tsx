...
const handleSubmit = async (e:React.FormEvent<HTMLFormElement>)=>{
    ...
    try{
        ...
        const {data} = await axios.post<VerifyResponse>(`${user_service}/api/v1/verify`,{
            email,
            otp: otpString
        })
...
<button
className='absolute top-0 left-0 p-2 text-gray-100 hover:text-amber-300'
...
OTP has been sent to your Email Address (6 Digit)
</p>
