        ...
        <div className='max-w-md w-full'>
            <div className='bg-gray-800 border-bs-gray-700 rounded-lg p-8'>
                <div className='text-center mb-8'>
                    ...
                    <h1 className='text-4xl font-bold text-white mb-3'>Welcome to chat App</h1>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                    <div>
                        ...
                        placeholder='Enter your Email address' value={email} onChange={e=>setEmail(e.target.value)} required/>
